...
;; *************** function _main *****************
;; Defined at:
;;		line 28 in file "D:\Desktop\3rd year 2nd sem\Embedded Systems\Practical Activities\Pratical Activity #7\MPLAB Project Directory\7-3\LE7-3.c"
...
psect	maintext,global,class=CODE,delta=2,split=1
	file	"D:\Desktop\3rd year 2nd sem\Embedded Systems\Practical Activities\Pratical Activity #7\MPLAB Project Directory\7-3\LE7-3.c"
	line	28
global __pmaintext
...
l3293:	
;LE7-3.c: 29: int res = (int)(pow(2,14));
	movlw	0x0
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	movwf	(pow@y)^080h
...
l3297:	
;LE7-3.c: 30: unsigned int RH_temp = 0x0000, T_temp = 0x0000;
...
l3301:	
;LE7-3.c: 31: unsigned char temp = 0x00;
	clrf	(main@temp)^080h
	line	33
	
l3303:	
;LE7-3.c: 32: float rh, t;
;LE7-3.c: 33: TRISB = 0x00;
	clrf	(134)^080h	;volatile
	line	34
	
l3305:	
;LE7-3.c: 34: TRISD = 0x00;
	clrf	(136)^080h	;volatile
	line	35
	
l3307:	
;LE7-3.c: 35: PORTB = 0x00;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(6)	;volatile
	line	36
...
l3309:	
;LE7-3.c: 36: PORTD = 0x00;
	clrf	(8)	;volatile
	line	37
	
l3311:	
;LE7-3.c: 37: init_I2C_Master();
...
l3315:	
;LE7-3.c: 43: I2C_Start();
	fcall	_I2C_Start
	line	44
	
l3317:	
;LE7-3.c: 44: I2C_Send(0x80);
	movlw	(080h)
	fcall	_I2C_Send
	line	45
	
l3319:	
;LE7-3.c: 45: I2C_Send(0xE5);
	movlw	(0E5h)
	fcall	_I2C_Send
	line	46
	
l3321:	
;LE7-3.c: 46: I2C_RepeatedStart();
	fcall	_I2C_RepeatedStart
	line	47
	
l3323:	
;LE7-3.c: 47: I2C_Send(0x81);
	movlw	(081h)
	fcall	_I2C_Send
	line	48
	
l3325:	
;LE7-3.c: 48: RH_temp = I2C_Receive(1);
	movlw	(01h)
	fcall	_I2C_Receive
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
l3337:	
;LE7-3.c: 56: RH_temp = RH_temp | temp;
	movf	(main@RH_temp)^080h,w
...
l3339:	
;LE7-3.c: 58: rh = (float)(-6+(125*((float)RH_temp/(float)res)));
	movlw	0x0
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(___ftadd@f1)
...
l3343:	
;LE7-3.c: 62: I2C_Start();
	fcall	_I2C_Start
	line	63
	
l3345:	
;LE7-3.c: 63: I2C_Send(0x80);
	movlw	(080h)
	fcall	_I2C_Send
	line	64
	
l3347:	
;LE7-3.c: 64: I2C_Send(0xE3);
	movlw	(0E3h)
	fcall	_I2C_Send
	line	65
...
l3355:	
;LE7-3.c: 71: I2C_Start();
	fcall	_I2C_Start
	line	72
	
l3357:	
;LE7-3.c: 72: I2C_Send(0x80);
	movlw	(080h)
	fcall	_I2C_Send
	line	73
	
l3359:	
;LE7-3.c: 73: I2C_Send(0xE3);
	movlw	(0E3h)
	fcall	_I2C_Send
	line	74
	
l3361:	
;LE7-3.c: 74: I2C_RepeatedStart();
	fcall	_I2C_RepeatedStart
	line	75
	
l3363:	
;LE7-3.c: 75: I2C_Send(0x81);
	movlw	(081h)
	fcall	_I2C_Send
	line	76
	
l3365:	
;LE7-3.c: 76: T_temp = I2C_Receive(1);
	movlw	(01h)
	fcall	_I2C_Receive
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
l3379:	
;LE7-3.c: 85: t = (float)(-46.85+(175.72*((float)T_temp/(float)res)));
	movlw	0x66
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(___ftadd@f1)
...
l3383:	
;LE7-3.c: 89: I2C_Start();
	fcall	_I2C_Start
	line	90
	
l3385:	
;LE7-3.c: 90: I2C_Send(0x80);
	movlw	(080h)
	fcall	_I2C_Send
	line	91
	
l3387:	
;LE7-3.c: 91: I2C_Send(0xE5);
	movlw	(0E5h)
	fcall	_I2C_Send
	line	92
...
;; Defined at:
;;		line 189 in file "D:\Desktop\3rd year 2nd sem\Embedded Systems\Practical Activities\Pratical Activity #7\MPLAB Project Directory\7-3\LE7-3.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l3205:	
;LE7-3.c: 190: TRISC3 = 1;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	bsf	(1083/8)^080h,(1083)&7	;volatile
	line	191
;LE7-3.c: 191: TRISC4 = 1;
	bsf	(1084/8)^080h,(1084)&7	;volatile
	line	192
	
l3207:	
;LE7-3.c: 192: SSPCON = 0x28;
	movlw	(028h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(20)	;volatile
...
l3211:	
;LE7-3.c: 195: SSPSTAT = 0x00;
	clrf	(148)^080h	;volatile
	line	196
;LE7-3.c: 196: SSPADD = 0x09;
	movlw	(09h)
...
;; *************** function _initLCD *****************
;; Defined at:
;;		line 114 in file "D:\Desktop\3rd year 2nd sem\Embedded Systems\Practical Activities\Pratical Activity #7\MPLAB Project Directory\7-3\LE7-3.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;LE7-3.c: 115: delay_ms(1);
	...
	fcall	_delay_ms
	line	116
;LE7-3.c: 116: instCtrl(0x38);
	movlw	(038h)
	fcall	_instCtrl
	line	117
;LE7-3.c: 117: instCtrl(0x01);
	movlw	(01h)
	fcall	_instCtrl
	line	118
;LE7-3.c: 118: instCtrl(0x06);
	movlw	(06h)
	fcall	_instCtrl
	line	119
;LE7-3.c: 119: instCtrl(0x0E);
	movlw	(0Eh)
	fcall	_instCtrl
	line	120
...
;; *************** function _dispT *****************
;; Defined at:
;;		line 155 in file "D:\Desktop\3rd year 2nd sem\Embedded Systems\Practical Activities\Pratical Activity #7\MPLAB Project Directory\7-3\LE7-3.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
...
l3261:	
;LE7-3.c: 156: instCtrl(0xC0);
	movlw	(0C0h)
	fcall	_instCtrl
	line	158
;LE7-3.c: 158: dataCtrl('T');
	movlw	(054h)
	fcall	_dataCtrl
	line	159
;LE7-3.c: 159: dataCtrl('e');
	movlw	(065h)
	fcall	_dataCtrl
	line	160
;LE7-3.c: 160: dataCtrl('m');
	movlw	(06Dh)
	fcall	_dataCtrl
	line	161
;LE7-3.c: 161: dataCtrl('p');
	movlw	(070h)
	fcall	_dataCtrl
	line	162
;LE7-3.c: 162: dataCtrl('e');
	movlw	(065h)
	fcall	_dataCtrl
	line	163
;LE7-3.c: 163: dataCtrl('r');
	movlw	(072h)
	fcall	_dataCtrl
	line	164
;LE7-3.c: 164: dataCtrl('a');
	movlw	(061h)
	fcall	_dataCtrl
	line	165
;LE7-3.c: 165: dataCtrl('t');
	movlw	(074h)
	fcall	_dataCtrl
	line	166
;LE7-3.c: 166: dataCtrl('u');
	movlw	(075h)
	fcall	_dataCtrl
	line	167
;LE7-3.c: 167: dataCtrl('r');
	...
	fcall	_dataCtrl
	line	168
;LE7-3.c: 168: dataCtrl('e');
	movlw	(065h)
	fcall	_dataCtrl
	line	169
;LE7-3.c: 169: dataCtrl(':');
	movlw	(03Ah)
	fcall	_dataCtrl
	line	172
	
l3263:	
;LE7-3.c: 171: char val[5];
;LE7-3.c: 172: val[0] = ' ';
	movlw	(020h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
...
l3285:	
;LE7-3.c: 184: dataCtrl(' ');
	movlw	(020h)
	fcall	_dataCtrl
	line	185
	
l3287:	
;LE7-3.c: 185: dataCtrl('C');
	movlw	(043h)
	fcall	_dataCtrl
	line	186
...
;; *************** function _dispRH *****************
;; Defined at:
;;		line 131 in file "D:\Desktop\3rd year 2nd sem\Embedded Systems\Practical Activities\Pratical Activity #7\MPLAB Project Directory\7-3\LE7-3.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
...
l3245:	
;LE7-3.c: 132: instCtrl(0x80);
	movlw	(080h)
	fcall	_instCtrl
	line	134
;LE7-3.c: 134: dataCtrl('H');
	movlw	(048h)
	fcall	_dataCtrl
	line	135
;LE7-3.c: 135: dataCtrl('u');
	movlw	(075h)
	fcall	_dataCtrl
	line	136
;LE7-3.c: 136: dataCtrl('m');
	movlw	(06Dh)
	fcall	_dataCtrl
	line	137
;LE7-3.c: 137: dataCtrl('i');
	movlw	(069h)
	fcall	_dataCtrl
	line	138
;LE7-3.c: 138: dataCtrl('d');
	movlw	(064h)
	fcall	_dataCtrl
	line	139
;LE7-3.c: 139: dataCtrl('i');
	movlw	(069h)
	fcall	_dataCtrl
	line	140
;LE7-3.c: 140: dataCtrl('t');
	movlw	(074h)
	fcall	_dataCtrl
	line	141
;LE7-3.c: 141: dataCtrl('y');
	movlw	(079h)
	fcall	_dataCtrl
	line	142
;LE7-3.c: 142: dataCtrl(':');
	movlw	(03Ah)
	fcall	_dataCtrl
	line	145
	
l3247:	
;LE7-3.c: 144: char val[4];
;LE7-3.c: 145: val[2] = ' ';
	movlw	(020h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
...
;; *************** function _instCtrl *****************
;; Defined at:
;;		line 107 in file "D:\Desktop\3rd year 2nd sem\Embedded Systems\Practical Activities\Pratical Activity #7\MPLAB Project Directory\7-3\LE7-3.c"
;; Parameters:    Size  Location     Type
...
;; *************** function _dataCtrl *****************
;; Defined at:
;;		line 122 in file "D:\Desktop\3rd year 2nd sem\Embedded Systems\Practical Activities\Pratical Activity #7\MPLAB Project Directory\7-3\LE7-3.c"
;; Parameters:    Size  Location     Type
...
;; *************** function _delay_ms *****************
;; Defined at:
;;		line 99 in file "D:\Desktop\3rd year 2nd sem\Embedded Systems\Practical Activities\Pratical Activity #7\MPLAB Project Directory\7-3\LE7-3.c"
;; Parameters:    Size  Location     Type
;;  cnt             2    0[COMMON] int 
;; Auto vars:     Size  Location     Type
;;  j               2    4[COMMON] int 
...
;; *************** function _I2C_Stop *****************
;; Defined at:
;;		line 212 in file "D:\Desktop\3rd year 2nd sem\Embedded Systems\Practical Activities\Pratical Activity #7\MPLAB Project Directory\7-3\LE7-3.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _I2C_Start *****************
;; Defined at:
;;		line 205 in file "D:\Desktop\3rd year 2nd sem\Embedded Systems\Practical Activities\Pratical Activity #7\MPLAB Project Directory\7-3\LE7-3.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _I2C_Send *****************
;; Defined at:
;;		line 226 in file "D:\Desktop\3rd year 2nd sem\Embedded Systems\Practical Activities\Pratical Activity #7\MPLAB Project Directory\7-3\LE7-3.c"
;; Parameters:    Size  Location     Type
;;  data            1    wreg     unsigned char 
;; Auto vars:     Size  Location     Type
...
l3219:	
;LE7-3.c: 228: I2C_Wait();
	fcall	_I2C_Wait
	line	230
	
l3221:	
;LE7-3.c: 230: SSPBUF = data;
...
;; Defined at:
;;		line 219 in file "D:\Desktop\3rd year 2nd sem\Embedded Systems\Practical Activities\Pratical Activity #7\MPLAB Project Directory\7-3\LE7-3.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; Defined at:
;;		line 233 in file "D:\Desktop\3rd year 2nd sem\Embedded Systems\Practical Activities\Pratical Activity #7\MPLAB Project Directory\7-3\LE7-3.c"
;; Parameters:    Size  Location     Type
...
l3227:	
;LE7-3.c: 234: unsigned char temp;
;LE7-3.c: 235: I2C_Wait();
	fcall	_I2C_Wait
	line	236
...
;LE7-3.c: 236: RCEN = 1;
	...
	line	237
;LE7-3.c: 237: I2C_Wait();
	fcall	_I2C_Wait
	line	238
	
l3231:	
;LE7-3.c: 238: temp = SSPBUF;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(19),w	;volatile
...
;; *************** function _I2C_Wait *****************
;; Defined at:
;;		line 199 in file "D:\Desktop\3rd year 2nd sem\Embedded Systems\Practical Activities\Pratical Activity #7\MPLAB Project Directory\7-3\LE7-3.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l3083:	
;LE7-3.c: 202: while((SSPCON2 & 0x1F) || (SSPSTAT & 0x04));
	goto	l3085
